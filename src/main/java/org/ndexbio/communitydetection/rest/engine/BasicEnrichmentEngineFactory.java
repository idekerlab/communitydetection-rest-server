...
public class BasicEnrichmentEngineFactory {
     ...
     * @return 
     */
    public CommunityDetectionEngine getEnrichmentEngine() throws EnrichmentException {
    ...
    protected void addGeneMapToEnricher(CommunityDetectionEngineImpl enricher,
